...
class _HomePageState extends State<HomePage> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          RaisedButton(
            onPressed: this._getDioData,
            child: Text('dio请求数据'),
          ),
          RaisedButton(
            onPressed: this._postDioData,
            child: Text('dio提交数据'),
          ),
        ],
      ),
  ...
  void _getDioData() async {
    var url = "http://a.itying.com/api/productlist";
    Response response = await Dio().get(url);
    print(response.data);
  }

  void _postDioData() async {
    Map jsonData = {"username": "wwj", "age": "20"};
    var url = "http://a.itying.com/api/productlist";
